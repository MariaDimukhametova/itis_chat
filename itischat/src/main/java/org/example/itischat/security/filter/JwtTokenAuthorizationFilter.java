...
import org.example.itischat.security.config.JwtSecurityConfig;
...
public class JwtTokenAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        if (request.getRequestURI().equals(JwtSecurityConfig.LOGIN_FILTER_PROCESSES_URL)) {
    ...
    private void sendForbidden(HttpServletResponse response) throws IOException {
        ...
        objectMapper.writeValue(response.getWriter(), Collections.singletonMap("error", "user not found by token"));
    }
}
